...
# Date range for the older patent data
START_DATE = "1790-07-31"
END_DATE = "2002-02-01"
...
def ensure_bulk_dir():
    """Ensure the bulk-older directory exists"""
...
def main():
    ...
    logging.info("Starting Patent Grant Multi-page PDF Images download process")
